...
Reads `02-reactivity-prediction/copol_prediction/processed_data.csv` (or a directory of legacy
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        help=(
            ...
            "Default: 02-reactivity-prediction/copol_prediction/processed_data.csv."
        ),
    )
    parser.add_argument(
        "--output",
