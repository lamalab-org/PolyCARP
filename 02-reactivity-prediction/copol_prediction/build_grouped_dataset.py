...
Usage::
    ...
    python 02-reactivity-prediction/copol_prediction/build_grouped_dataset.py

    # Or from a specific snapshot.
    python 02-reactivity-prediction/copol_prediction/build_grouped_dataset.py \\
        --source 02-reactivity-prediction/copol_prediction/paper_dataset/processed_data.csv \\
        --output 02-reactivity-prediction/copol_prediction/paper_dataset/grouped_by_unique_monomer_pairs.csv
"""
...
DEFAULT_SOURCE = PACKAGE_ROOT / "processed_data.csv"
DEFAULT_OUTPUT = PACKAGE_ROOT / "paper_dataset" / "grouped_by_unique_monomer_pairs.csv"
