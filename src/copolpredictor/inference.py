...
class CopolymerPredictor:
    ...
    def predict_with_confidence(
        self, X: Union[pd.DataFrame, dict, np.ndarray]
    ) -> Dict[str, np.ndarray]:
        """
    ...
    def predict_r_product_range(self, X: Union[pd.DataFrame, dict, np.ndarray]) -> List[str]:
        """
...
def batch_predict(
    input_csv: str, output_csv: str, model_path: str = "artifacts/model_bundle"
) -> pd.DataFrame:
    """
