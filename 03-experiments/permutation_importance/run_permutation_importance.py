...
def parse_args():
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="Directory with train.csv, val.csv, test.csv (default: 02-reactivity-prediction/copol_prediction/artifacts/data_splits). Use artifacts/data_splits_full_features for full feature_columns_all.",
    )
    parser.add_argument(
...
def get_split_dir(split_dir_arg=None):
    if split_dir_arg:
        ...
        copol_dir = os.path.join(_script_dir, "../../02-reactivity-prediction/copol_prediction")
