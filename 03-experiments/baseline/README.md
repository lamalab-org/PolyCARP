...
python compare_models.py \
    --base-model-path ../../02-reactivity-prediction/copol_prediction/artifacts/model_bundle \
...
- All models are evaluated on the same test set from `../../02-reactivity-prediction/copol_prediction/artifacts/data_splits/`
